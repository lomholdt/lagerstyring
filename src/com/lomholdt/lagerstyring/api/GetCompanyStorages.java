...
/**
 * Servlet implementation class GetCompanyStorages
 */
@WebServlet("/GetCompanyStorages")
public class GetCompanyStorages extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.print("Permission denied for getting company storages");
			e1.printStackTrace();
		}
		...
		try {
			...
			ArrayList<Storage> alp =  is.getStorages(companyId);

            ...
            <div class="col-sm-8 col-sm-offset-2">
            	<form method="POST" action="movein">
	                    <div class="panel panel-default">
	                        <div class="panel-heading"><h3 class="panel-title">${storage.name} - tilgang</h3></div>
					            ...
					            <div class="panel-footer">
					                ...
					                <div class="row">
					               	...
					               	<!-- 	<c:forEach var="secondaryStation" items="${secondaryStations}">
											<button type="submit" class="btn btn-primary btn-lg" name="stationId" value="${secondaryStation.id}">${secondaryStation.name}</button>
										</c:forEach> -->
